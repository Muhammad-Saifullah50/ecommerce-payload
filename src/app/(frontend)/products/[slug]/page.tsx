    ...
    return (
        <section className='flex flex-col gap-4 py-4'>
            <div className='flex gap-2 text-gray-primary text-base'>
                Home <ChevronRight className='w-4' /> {categoryName} <ChevronRight className='w-4' /> {subCategoryName} <ChevronRight className='w-4' /> {product.docs[0].title}
            </div>
            ...
            <section className='flex gap-4 '>
                ...
                <section className="flex gap-4 p-4 bg-white border rounded-lg w-2/6">
                    <MayLikeProducts subcategory={product.docs[0].subcategory!} currentProduct={product.docs[0]} />
                </section>
            </section>
            <section className="flex gap-4 p-4 bg-white border rounded-lg">
