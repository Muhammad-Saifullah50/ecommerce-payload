...
const FilterSidebar = async ({ parameters }: { parameters: { [key: string]: string | string[] | undefined } }) => {
                    ...
                    <AccordionContent className="flex flex-col gap-2">
                        {categories.docs.map((category) => {
                            ...
                            return (<Link
                                ...
                                href={`/shop/?category=${category.value}`}>{category.label}
                            </Link>)
                        })}
                    </AccordionContent>
                </AccordionItem>
