  ...
  return (
    <div className="w-full flex flex-col gap-4">
      {categories.docs.map((category) => {
        ...
        return (
          <div
            className="grid lg:grid-cols-6 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 grid-rows-2 "
            key={category.id}
          >
            <div className="col-span-2 row-span-2 relative">
              ...
              <div className="absolute top-0 p-8 flex flex-col gap-6">
                ...
                <Link href={category.link}>
                  <Button className="bg-white text-black hover:bg-white/55 " size={'lg'}>
                    Shop Now
                  </Button>
                </Link>
              </div>
            ...
            {subcategories.map(async (subcategory, index) => {
              ...
              return (
                <div key={index} className="border w-full flex">
